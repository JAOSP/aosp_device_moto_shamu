...
MAGURO_BLOBS="broadcom-shamu-mra58k-1812597c.tgz
              moto-shamu-mra58k-cb852ccf.tgz
              qcom-shamu-mra58k-f489064e.tgz"

CSUM_LIST="$PWD/blob-shasums"

cd ../../.. &&
install_blobs nexus-6 "$MAGURO_BLOBS" "$CSUM_LIST"
